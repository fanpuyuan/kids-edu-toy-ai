...
## 🚀 未来路线图 (Roadmap)
我们正在规划以下激动人心的特性升级，进一步提升智能玩具的陪伴体验：
...
- [ ] **边缘端唤醒词 (Wake Word Engine)**:
  - 探索在实际玩具端部署 Porcupine 等极轻量级离线唤醒词引擎，实现免按键的“嗨，小巴”纯语音全双工唤醒。
- [ ] **高敏情绪分析与家长告警推送**:
  - 在 LangGraph 中引入情绪分析节点，当由于校园欺凌或负面情绪导致连续出现低落词汇时，通过第三方接口主动向家长微信/邮箱推送预警。
